...
from Contracts import MoexCurrencyDataSource, LoggedDataSource, IndicatorPredictor, LoggedPredictor, DummyStrategy, LoggedStrategy, HalfInAssessor, LoggedAssessor, BackgroundPollingExecutor, LoggedExecutor, MockContextProvider, LoggedContextProvider
...
class MainFactory(IFactory[INextCandlePrediction, IDirectionSignal, ITurnBackAction]):
    ...
    def __init__(self, assetPair: IAssetPair, tickerCode: str):
        ...
        self._predictor = LoggedPredictor(IndicatorPredictor(), predictorLogger)
