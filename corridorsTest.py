...
resultFolder = "strategyResult/KZTRUB_TOM_threshold_corridor_up"

stop_coef = 0.1

for assessorIndex in range(20):
    ...
    testingDataSource = MoexCurrencyDataSource(
        assetPair, "KZTRUB_TOM", 1651171835, 1701171835, IntervalType.OneDay
    )
